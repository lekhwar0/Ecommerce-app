...
const Header = () => {
  ...
  const navList = (
    <ul className="my-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 text-white text-center font-medium">
      <SearchInput />
        ...
        <>
          <Menu>
            ...
            <MenuList>
              ...
              {/* <MenuItem className="my-hover-effect-1 mt-2 flex items-center gap-2 outline-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
